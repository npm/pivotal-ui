...
/***/ function(module, exports) {
	...
	var FormStepper = function FormStepper(el, input, decrementButton, incrementButton) {
	  this.stepper = $(el);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(1);
	__webpack_require__(34).stepper;
	 ...
	 */
	var SVGeople = function SVGeople(el, amountOfPeopleFiles, shownCount, root) {
	...
	SVGeople.prototype.addPeopleToContainer = function () {
	  var people = Array.prototype.map.call(arguments, function (person, idx) {
	    return "<div class='person-container'>" + person + "</div>";
	  }).join('');
	...
	SVGeople.prototype.populate = function () {
	  ...
	  this.getPeople().then(this.addPeopleToContainer.bind(this)).then(this.changePeopleShown.bind(this, this.shownCount)).done(this.el.trigger.bind(this.el, "SVGeople:populated")).fail(console.log);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.stepper = __webpack_require__(35);
