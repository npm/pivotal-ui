  ...
  render() {
    ...
    return <Layout>
      <div className="row man">
        <div className="col-xs-4 pan">
          <StyleguideNav navTree={categorylistToOldNav(categories)} lang={lang} />
        </div>
        <Col md={20}>
...
module.exports = function render(categories, docs, category, lang) {
  return React.renderToStaticMarkup(<Styleguide categories={categories} docs={docs} category={category} lang={lang} />)
}
